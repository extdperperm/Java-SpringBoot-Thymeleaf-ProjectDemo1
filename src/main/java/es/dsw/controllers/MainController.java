...
/* [9] - CREACIÓN DE LAS CONTROLADORAS
 * 
...
public class MainController {
	 ...
	 * lógica de la controladora y por ende misma vista index.html en este caso.
	 */
	@GetMapping({"/", "/index"})
	public String index() {
		return "index";  
	 ...
	 * la controladora no los recoge pero si observas su vista delegada example2.html, esta última, utiliza la notación Expression language (EL) para renderizar la vista mostrando los datos.*/
	@GetMapping({"/ejemplo2"})
	public String ejem2() {
		return "example2"; 
	}
	...
	@GetMapping({"/MasEjemplos/ejemplo4"})
	public String ejem4() {
		return "example4";
	}
